...
import { Mail, Lock, User, Loader2, ArrowRight, Code2 } from 'lucide-react';
        ...
        <div className="bg-[#161b22] border border-white/10 p-8 rounded-2xl shadow-2xl backdrop-blur-sm">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="text-xs text-gray-500 px-1">
              By clicking Sign Up, you agree to our <a href="#" className="text-green-500 hover:underline">Terms</a> and <a href="#" className="text-green-500 hover:underline">Privacy Policy</a>.
            </p>
          ...
          <div className="mt-8 pt-8 border-t border-white/5 text-center">
            <p className="text-gray-400">
              ...
              <Link to="/login" className="text-green-500 font-semibold hover:text-green-400 transition-colors">Sign in</Link>
            </p>
          </div>
        </div>
      </motion.div>
