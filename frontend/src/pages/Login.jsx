    ...
    <div className="min-h-screen bg-[#0d1117] flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Continue your collaborative coding journey</p>
        </div>
        ...
        <div className="bg-[#161b22] border border-white/10 p-8 rounded-2xl shadow-2xl backdrop-blur-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <button type="button" onClick={handleForgotPassword} className="text-sm font-medium text-green-500 hover:text-green-400 transition-colors">Forgot password?</button>
              </div>
              <div className="relative">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-green-600 hover:bg-green-500 disabled:bg-green-600/50 text-white font-bold py-3 px-4 rounded-xl transition-all shadow-lg shadow-green-900/30 flex justify-center items-center space-x-2 group active:scale-[0.98]"
            >
              {loading ? (
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#161b22] px-2 text-gray-500 font-medium">Or continue with</span>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-white/5 text-center">
            <p className="text-gray-400">
              ...
              <Link to="/register" className="text-green-500 font-semibold hover:text-green-400 transition-colors">Create account</Link>
            </p>
          </div>
        </div>
      </motion.div>
